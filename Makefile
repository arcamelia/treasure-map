...
#object files
testMaze.o : testMaze.cpp cs221util/PNG.h cs221util/RGBAPixel.h stack.h queue.h deque.h treasureMap.h treasureMap.cpp decoder.h decoder.cpp stack.cpp queue.cpp deque.cpp
	$(CXX) $(CXXFLAGS) testMaze.cpp

testStackQueue.o : testStackQueue.cpp cs221util/PNG.h cs221util/RGBAPixel.h stack.h queue.h deque.h stack.cpp queue.cpp deque.cpp
...
treasureMap.o : treasureMap.h treasureMap.cpp cs221util/RGBAPixel.h cs221util/PNG.h queue.h queue.cpp 
	$(CXX) $(CXXFLAGS) treasureMap.cpp -o $@

decoder.o : decoder.h decoder.cpp cs221util/RGBAPixel.h cs221util/PNG.h stack.cpp queue.h queue.cpp stack.h stack.cpp
