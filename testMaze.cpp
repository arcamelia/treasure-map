...
// TEST_CASE("decoder::z maze", "[weight=1][part=decoder]")
// {
// 	PNG maze;
// 	maze.readFromFile("images/zdesmaze.jpg");
// 	pair<int,int> start(1,1);
...
//     cout << base.width() << endl;
	...
	// treasure.writeToFile("images/MAPTEST.png");
    // PNG treasureans;
    // treasureans.readFromFile("images/zdesembedded.png");
    // REQUIRE( treasure == treasureans );
    ...
    // solnmaze.writeToFile("images/RENDERMAZE.png");
    // PNG solnmazeans;
    // solnmazeans.readFromFile("images/zdessolnmaze.png");
    // REQUIRE( solnmaze == solnmazeans );
